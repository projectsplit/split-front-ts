  ...
  return (
    <StyledDateTimePicker>
      ...
      {showTimePicker && <div className='time-picker'>
        <ScrollPicker items={hours} selectedIndex={selectedDateTime.hour()} setSelectedIndex={i => onHourChange(i)} />
        <ScrollPicker items={minutes} selectedIndex={closestMinuteIndex(selectedDateTime)} setSelectedIndex={i => onMinuteChange(i)} />
      </div>}
    </StyledDateTimePicker>
  )
}
