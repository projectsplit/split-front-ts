...
const ScrollPicker = ({ items, selectedIndex, setSelectedIndex }: ScrollPickerProps) => {
  ...
  const semiVisibleItemHeight = containerHeight % itemHeight
  ...
  console.log('---------------')
  console.log('semiVisibleItemHeight', semiVisibleItemHeight)
  console.log('visibleItemsCount', visibleItemsCount)
  console.log('itemsBeforeCenterItem', itemsBeforeCenterItem)
